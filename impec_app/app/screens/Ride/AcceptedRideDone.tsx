...
interface AcceptedRideDoneRideProps {
  isDone?: boolean;
}

const AcceptedRideDone: React.FC<AcceptedRideDoneRideProps> = ({isDone}) => {
  const {API} = useApi();
  ...
  const userQuery = useQuery('accepted_done', readAgendaCourse);
...
export default AcceptedRideDone;
